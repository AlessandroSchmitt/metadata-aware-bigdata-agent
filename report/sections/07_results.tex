...
Taken together, the experiments show that the metadata layer affects both
downstream SQL correctness and model-processing cost, while the scaling
experiments expose the limits of aggressive metadata selection and the
behaviour of the Spark execution layer. These implications are analysed in
